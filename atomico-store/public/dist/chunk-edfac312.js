...
var style = ":host{padding:.25rem 1rem;border-radius:5px;cursor:pointer;display:inline-flex;align-items:center;background:var(--theme-atomico-dark,#000);color:var(--theme-atomico-white,#fff)}.counter,:host(.checked){background:var(--theme-atomico-white,#fff);color:var(--theme-atomico-dark,#000)}.counter{width:16px;height:16px;border-radius:50%;display:flex;align-items:center;justify-content:center;font-size:10px;font-weight:700;margin-left:.5rem}:host(.checked) .counter{background:var(--theme-atomico-dark,#000);color:var(--theme-atomico-white,#fff)}";
...
export { useMemo as a, toList as b, createElement as c, useState as d, useEffect as e, customElement as f, useReducer as g, AtomicoStoreButton as h };
//# sourceMappingURL=chunk-edfac312.js.map
